...
export default function FireStationBondPage({ params }: { params: { electionSlug: string } }) {
    ...
    <main className="min-h-screen bg-pattern">
      <header className="bg-terracotta-600 text-white">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <Nav electionSlug={electionSlug} electionName={electionData.election.name} currentPage="Fire Station Bond" />
          <div className="flex items-center gap-3 mb-2">
            <span className="bg-white/20 text-white text-sm font-medium px-3 py-1 rounded-full">Article 3</span>
          </div>
          <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">Fire Station 1 Addition</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-sage-50 border-2 border-sage-200 rounded-2xl p-6 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="font-display font-bold text-sage-800 text-lg mb-1">No Property Tax Increase</h2>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6 mb-8">
          <h2 className="font-display text-xl font-bold text-warmgray-800 mb-4">What You&apos;re Voting On</h2>
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-warmgray-600 mt-1">{fireStationBond.currentStaffing}</p>
              </div>
            </div>
        ...
        {/* How It's Funded */}
        <div className="bg-white rounded-2xl shadow-soft p-6 mb-8">
          <h2 className="font-display text-xl font-bold text-warmgray-800 mb-4">How It&apos;s Funded</h2>
        ...
        {/* What Happens If */}
        <div className="bg-white rounded-2xl shadow-soft p-6 mb-8">
          <h2 className="font-display text-xl font-bold text-warmgray-800 mb-4">What Happens If...</h2>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-sage-50 border border-sage-200 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-warmgray-600 text-sm">
                <li className="flex items-start gap-2"><span className="text-sage-500 mt-1">•</span>Construction planning begins after voter approval</li>
                <li className="flex items-start gap-2"><span className="text-sage-500 mt-1">•</span>Permanent workspace for rental inspection staff</li>
                <li className="flex items-start gap-2"><span className="text-sage-500 mt-1">•</span>Improved facilities for firefighters on 24-hour shifts</li>
                <li className="flex items-start gap-2"><span className="text-sage-500 mt-1">•</span>No impact on property taxes</li>
              </ul>
            </div>
            <div className="bg-warmgray-50 border border-warmgray-200 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-warmgray-600 text-sm">
                <li className="flex items-start gap-2"><span className="text-warmgray-400 mt-1">•</span>Staff continues working from temporary trailer</li>
                <li className="flex items-start gap-2"><span className="text-warmgray-400 mt-1">•</span>City may seek alternative funding or bring back to voters</li>
                <li className="flex items-start gap-2"><span className="text-warmgray-400 mt-1">•</span>Capital fees and rental surplus remain in those funds</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        {/* Station Info */}
        <div className="bg-white rounded-2xl shadow-soft p-6 mb-8">
          <h2 className="font-display text-xl font-bold text-warmgray-800 mb-4">About Fire Station 1</h2>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link
              href={`/elections/${electionSlug}/budget`}
