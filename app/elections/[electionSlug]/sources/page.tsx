...
export default function SourcesPage({ params }: { params: { electionSlug: string } }) {
  ...
  const { election, resources, lastUpdated } = data;
  const year = new Date(election.date + 'T12:00:00').getFullYear();

  const allSources: { category: string; sources: { title: string; url: string }[] }[] = [];
    ...
    <main className="min-h-screen bg-pattern">
      <header className="bg-sage-600 text-white">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <Nav electionSlug={electionSlug} electionName={election.name} currentPage="Sources & Citations" />
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-warmgray-600 mt-1">
                ...
                <span className="font-semibold text-sage-700">{formatDate(lastUpdated)}</span>.
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6 mb-8">
          ...
          <div className="prose prose-warmgray max-w-none text-warmgray-600">
            <p className="mb-4">
              This nonpartisan voter guide was created to help {election.location.split(',')[0]} residents make informed decisions
              for Town Meeting Day {year}. The information presented here comes directly from:
            </p>
      ...
      <footer className="bg-warmgray-100 border-t border-warmgray-200 mt-12">
        <div className="max-w-4xl mx-auto px-4 py-6 text-center">
          <p className="text-warmgray-500 text-sm">
            {election.name} {year} &middot; A nonpartisan community resource
          </p>
        </div>
      </footer>
    </main>
