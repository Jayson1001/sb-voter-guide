    ...
    <main className="min-h-screen bg-pattern">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <nav
          ...
          className="sticky top-14 z-30 -mx-2 sm:-mx-3 lg:-mx-4 mb-8 bg-white/95 backdrop-blur-sm border border-sage-200 rounded-xl shadow-soft"
        >
          <div className="flex items-center gap-2 px-3 sm:px-4 py-2.5 overflow-x-auto lg:justify-center">
